    ...
    public function getProductLedger()
    {
        ...
        $result = $this->db->query("
            select
                ...
                pm.PurchaseMaster_OrderDate as date,pm.reference as ref,
            ...
            select 
                ...
                sm.SaleMaster_SaleDate as date,sm.reference as ref,
            ...
            select 
                ...
                pr.PurchaseReturn_ReturnDate as date,'' as ref,
            ...
            select
                ...
                sr.SaleReturn_ReturnDate as date,'' as ref,
            ...
            select
                ...
                tm.transfer_date as date,'' as ref,
    ...
    public function getTotalStock()
    {
        ...
        $stock = $this->db->query("
            select
                ...
                (select sum(purchase_total) as purchase_total
                        from tbl_product_serial_numbers
                        where ps_prod_id = p.Product_SlNo
                        AND ps_p_r_status <> 'yes'
                        AND ps_brunch_id = '$branchId'
                        AND (ps_s_status IS NULL OR ps_s_status <> 'yes' OR ps_s_r_status = 'yes') ) as purchase_total_am,
