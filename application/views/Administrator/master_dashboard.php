...
<head>
    ...
    <link rel="icon" type="image/png"
        href="<?= base_url(); ?>uploads/company_profile_thum/<?php echo $companyInfo->Company_Logo_thum; ?>"
        sizes="150x150">
            ...
            <div class="navbar-header pull-left">
                <a href="<?php echo base_url(); ?>" class="navbar-brand">
                    <small>
                        ...
                        <!--Enterprise Resource Planning--><?php echo $companyInfo->Company_Name; ?> <span
                            style="color:#000;font-weight:700;letter-spacing:1px;font-size:16px;"> <?php //echo $this->session->userdata('Brunch_name'); 
																																													?> </span>
                    </small>
                </a>
            </div>
                    ...
                    <li class="formMobileClock">
                        <a class="clock" style="background:#438EB9 !important;">
                            <span style="font-size:20px;"><i class="ace-icon fa fa-clock-o"></i></span> <span
                                style="font-size:15px;"><?php date_default_timezone_set('Asia/Dhaka');
																																		echo date("l, d F Y"); ?>,&nbsp;<span id="timer"
                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    ...
                    <div class="nav-search" id="nav-search">
                        ...
                        <span style="font-weight: bold; color: #972366; font-size: 16px;">
                            ...
                            <img src="<?= $branch_logo ?>" alt="<?php echo $this->session->userdata('Brunch_name');  ?>"
                ...
                <div class="page-content">
                    ...
                    <div id="loader" hidden
                        ...
                        <img src="<?php echo base_url(); ?>assets/loader.gif"
                            style="top: 30%; left: 50%; opacity: 1; position: fixed;">
                    </div>
                    <?php echo $content; ?>
                </div><!-- /.page-content -->
            </div>
            ...
            <div class="footer-inner">
                <div class="footer-content">
                    <span class="bigger-120">
                        Developed by <span class="blue bolder"><a href="http://linktechbd.com/" target="_blank">Link Up
                                Technology</a></span>
                    </span>
