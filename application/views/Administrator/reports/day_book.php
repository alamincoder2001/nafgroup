                            ...
                            <tbody>
                                ...
                                <template v-if="openingBalance.cashBalance != null">
                                    <tr>
                                        ...
                                        <td class="sub-value">{{ openingBalance.cashBalance.cash_balance | decimal }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Cash</td>
                                ...
                                <template v-if="loanReceives.length > 0">
                                    ...
                                    <tr v-for="transaction in loanReceives">
                                        <td>{{ transaction.bank_name }} {{ transaction.account_name }}
                                            {{ transaction.account_number }}</td>
                                        <td>{{ transaction.totalAmount | decimal }}</td>
                                    </tr>
                                </template>
                                ...
                                <template v-if="bankWithdraws.length > 0">
                                    <tr>
                                        <td class="sub-heading">Bank Withdraws <span style="color:red;">(Not
                                                Calculated)</span></td>
                                ...
                                <template v-if="bankDeposits.length > 0">
                                    <tr>
                                        <td class="sub-heading">Bank Deposits <span style="color:red;">(Not
                                                Calculated)</span></td>
                        ...
                        <table class="day-book-table">
                            ...
                            <tbody>
                                ...
                                <template v-if="closingBalance.cashBalance != null">
                                    <tr>
                                        <td class="sub-heading">Cash in Hand</td>
                                        <td class="sub-value">{{ closingBalance.cashBalance.cash_balance | decimal }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Cash</td>
    ...
    methods: {
        ...
        getPurchases() {
            axios.post('/get_purchases', this.filter)
                .then(res => {
                    let purchases = res.data.purchases.filter(purchase => purchase
                        .PurchaseMaster_PaidAmount > 0);
